...
const ListingCardComponent = ({
  ...
  return (
    <Card
      ...
      className={cn(
        "group relative flex flex-row lg:flex-col overflow-hidden cursor-pointer bg-card transition-all duration-300",
    ...
    >
      {/* Image Section - Maintained as sidebar until lg breakpoint */}
      <div
        ref={imageContainerRef}
        className="relative w-[110px] sm:w-[140px] md:w-[160px] lg:w-full flex-shrink-0 overflow-hidden min-h-[120px] lg:aspect-[16/9] lg:min-h-0"
      >
